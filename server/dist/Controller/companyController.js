...
exports.deleteMe = exports.updateMe = exports.getCompanyById = exports.getAllCompanies = void 0;
...
exports.getAllCompanies = (0, catchAsync_1.default)(async (req, res, next) => {
    const company = await db_1.db.company.findMany({
...
exports.getCompanyById = (0, catchAsync_1.default)(async (req, res, next) => {
...
exports.updateMe = (0, catchAsync_1.default)(async (req, res, next) => {
    ...
    const company = await db_1.db.company.update({
