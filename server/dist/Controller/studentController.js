...
exports.deleteMe = exports.updateMe = exports.getAllStudents = void 0;
...
exports.getAllStudents = (0, catchAsync_1.default)(async (req, res, next) => {
...
exports.updateMe = (0, catchAsync_1.default)(async (req, res, next) => {
    ...
    const user = await db_1.db.student.update({
